<h1 align="center" style="font-size: 52px;" > Welcome to    ANKUR BANK LIMITED  👋</h1>
...
================================================================================================*/
    ...
    //Account-1
    accounts[0].setName("ANKUR KUMAR DAS");
    ...
    //Account-2
    accounts[1].setName("ARYAN BANSAL");
    ...
    //Account-3
    accounts[2].setName("KARISMITA BAISHYA");
